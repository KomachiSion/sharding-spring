...
import io.shardingsphere.shardingjdbc.spring.namespace.parser.EncryptorBeanDefinitionParser;
import io.shardingsphere.shardingjdbc.spring.namespace.parser.KeyGeneratorBeanDefinitionParser;
...
public final class ShardingNamespaceHandler extends NamespaceHandlerSupport {
    ...
    public void init() {
        ...
        registerBeanDefinitionParser(ShardingDataSourceBeanDefinitionParserTag.ENCRYPTOR_REF_TAG, new EncryptorBeanDefinitionParser());
