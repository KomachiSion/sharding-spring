...
import io.shardingsphere.shardingjdbc.orchestration.spring.boot.common.SpringBootSagaConfigurationProperties;
...
public class OrchestrationSpringBootConfiguration implements EnvironmentAware {
    ...
    private DataSource createShardingDataSource() throws SQLException {
        ...
        ShardingDataSource shardingDataSource = new ShardingDataSource(
                dataSourceMap, new ShardingRule(shardingProperties.getShardingRuleConfiguration(), dataSourceMap.keySet()), configMapProperties.getConfigMap(),
                propProperties.getProps(), sagaConfigurationProperties.getSaga());
